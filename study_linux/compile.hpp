  ...
  public:
    ...
    static bool CompilerAndRun(const Json::Value& req,Json::Value* resp){
      ...
      if(!ret){
        ...
        LOG(INFO) << "Compile failde!" << std::endl;
        return false;
      }
      ...
      FileUtil::Read(StdoutPath(file_name), &str_stderr);
